...
<div class="container">
  ...
  <div class="col-md-4">
    <?php
      ...
      try{
        ...
        $row_select_skot = $sql_select_skot->fetch(PDO::FETCH_ASSOC);
  ...
  <div class="col-md-8"> 
    ...
    <br>
    <br>
    <h3 class="title"><?php echo $row_select_skot['product_name']; ?></h3>
    <p class="text">สายพันธ์ : <?php echo $row_select_skot['product_type_name']; ?></p>
    <p class="text">     สี : <?php echo $row_select_skot['product_color']; ?></p>
    <p class="text">  ผู้ขาย : <?php echo $row_select_skot['product_dealer']; ?></p>
    <p class="text">   อายุ : <?php echo $row_select_skot['product_age']; ?> ปี</p>
    <p class="text">  ราคา : <?php echo $row_select_skot['product_price']; ?>บาท</p>
  </div>
  </div>
</div>
